...
(async () => {
  ...
  try {
    ...
    // Wait an extra second to make sure hydration is complete and event listeners are attached
    ...
    await page.click('button:has-text("Generate")'); // Updated to just "Generate"

    // Wait for player to appear
    console.log("Waiting for player to appear...");
    await page.waitForSelector('.aspect-video', { state: 'visible', timeout: 60000 });
    ...
    // Try scrolling to ensure it's in view
